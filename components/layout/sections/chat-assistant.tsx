...
const QUICK_OPTIONS: QuickOption[] = [
  {
    ...
    message: "Can you tell me about Lybrook's main skills and experience?",
  },
  {
    text: "🚀 Project Collaboration",
    message:
      "I'm interested in working with Lybrook. What's the best way to start?",
  },
  {
    text: "💼 Past Projects",
    message: "Could you share some examples of Lybrook's past projects?",
  },
  {
    text: "⚡ AI Integration",
    message: "What kind of AI features can Lybrook implement in projects?",
  },
];
...
export default function ChatAssistant() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Hi! I'm Lybrooks's AI assistant. I can help you learn more about his skills, experience, or how he can help with your project. What would you like to know?",
      timestamp: new Date(),
    },
  ]);
      ...
      setMessages([
        {
          role: "assistant",
          content:
            "Hi! I'm Lybrook's AI assistant. I can help you learn more about his skills, experience, or how he can help with your project. What would you like to know?",
          timestamp: new Date(),
        },
      ]);
  ...
  useEffect(() => {
    console.log("Chat button rendered");
  }, []);
  ...
  className="fixed top-1/2 right-4 p-3 rounded-full bg-primary text-primary-foreground hover:opacity-90 border-2 border-red-500 transform -translate-y-1/2"
>
  <Bot size={20} />
</button>
      ...
      {isOpen && (
        <Draggable>
          <motion.div
            ...
            className='fixed bottom-0 right-0 w-full max-w-sm h-3/4 bg-muted border-l shadow-lg flex flex-col rounded-t-lg'
          >
            <div className='flex justify-between items-center px-4 py-2 border-b bg-muted rounded-t-lg'>
              ...
              <div className='flex items-center gap-2'>
                ...
                <motion.button
                  onClick={handleToggleChat}
                  className='hover:bg-background/80 p-1 rounded-md'
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
